...
// node_modules/dropbox/cjs/src/constants.js
var require_constants = __commonJS({
  "node_modules/dropbox/cjs/src/constants.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    var RPC = exports2.RPC = "rpc";
    var UPLOAD = exports2.UPLOAD = "upload";
    var DOWNLOAD = exports2.DOWNLOAD = "download";
    var APP_AUTH = exports2.APP_AUTH = "app";
    var USER_AUTH = exports2.USER_AUTH = "user";
    var TEAM_AUTH = exports2.TEAM_AUTH = "team";
    var NO_AUTH = exports2.NO_AUTH = "noauth";
    var COOKIE = exports2.COOKIE = "cookie";
    var DEFAULT_API_DOMAIN = exports2.DEFAULT_API_DOMAIN = "dropboxapi.com";
    var DEFAULT_DOMAIN = exports2.DEFAULT_DOMAIN = "dropbox.com";
    var TEST_DOMAIN_MAPPINGS = exports2.TEST_DOMAIN_MAPPINGS = {
      api: "api",
      notify: "bolt",
      content: "api-content"
    };
...
// node_modules/dropbox/cjs/lib/routes.js
var require_routes = __commonJS({
  "node_modules/dropbox/cjs/lib/routes.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
// node_modules/dropbox/cjs/src/utils.js
var require_utils = __commonJS({
  "node_modules/dropbox/cjs/src/utils.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.OAuth2TokenUrl = exports2.OAuth2AuthorizationUrl = exports2.baseApiUrl = void 0;
    exports2.httpHeaderSafeJson = httpHeaderSafeJson;
    exports2.getTokenExpiresAtDate = getTokenExpiresAtDate;
    exports2.isWindowOrWorker = isWindowOrWorker;
    exports2.isBrowserEnv = isBrowserEnv;
    exports2.isWorkerEnv = isWorkerEnv;
    exports2.createBrowserSafeString = createBrowserSafeString;
    var _constants = require_constants();
    function getSafeUnicode(c) {
      var unicode = "000".concat(c.charCodeAt(0).toString(16)).slice(-4);
      return "\\u".concat(unicode);
    }
    var baseApiUrl = exports2.baseApiUrl = function baseApiUrl2(subdomain) {
      var domain = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : _constants.DEFAULT_API_DOMAIN;
      var domainDelimiter = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ".";
      if (!domainDelimiter) {
        return "https://".concat(domain, "/2/");
      }
      if (domain !== _constants.DEFAULT_API_DOMAIN && _constants.TEST_DOMAIN_MAPPINGS[subdomain] !== void 0) {
        subdomain = _constants.TEST_DOMAIN_MAPPINGS[subdomain];
        domainDelimiter = "-";
      }
      return "https://".concat(subdomain).concat(domainDelimiter).concat(domain, "/2/");
    };
    var OAuth2AuthorizationUrl = exports2.OAuth2AuthorizationUrl = function OAuth2AuthorizationUrl2() {
      var domain = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : _constants.DEFAULT_DOMAIN;
      if (domain !== _constants.DEFAULT_DOMAIN) {
        domain = "meta-".concat(domain);
      }
      return "https://".concat(domain, "/oauth2/authorize");
    };
    var OAuth2TokenUrl = exports2.OAuth2TokenUrl = function OAuth2TokenUrl2() {
      var domain = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : _constants.DEFAULT_API_DOMAIN;
    ...
    function isWindowOrWorker() {
      return typeof WorkerGlobalScope !== "undefined" && self instanceof WorkerGlobalScope || typeof module2 === "undefined" || typeof window !== "undefined";
    }
...
// node_modules/dropbox/cjs/src/error.js
var require_error = __commonJS({
  "node_modules/dropbox/cjs/src/error.js"(exports2) {
    "use strict";
    ...
    var DropboxResponseError = exports2.DropboxResponseError = (function(_Error) {
...
// node_modules/dropbox/cjs/src/response.js
var require_response = __commonJS({
  "node_modules/dropbox/cjs/src/response.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    exports2.DropboxResponse = void 0;
    exports2.parseResponse = parseResponse;
    exports2.parseDownloadResponse = parseDownloadResponse;
    ...
    var DropboxResponse = exports2.DropboxResponse = function DropboxResponse2(status, headers, result) {
      _classCallCheck(this, DropboxResponse2);
      this.status = status;
...
// node_modules/dropbox/cjs/src/auth.js
var require_auth = __commonJS({
  "node_modules/dropbox/cjs/src/auth.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    ...
    var DropboxAuth = /* @__PURE__ */ (function() {
      function DropboxAuth2(options) {
        _classCallCheck(this, DropboxAuth2);
        options = options || {};
      ...
      _createClass(DropboxAuth2, [{
        ...
        value: function getAccessTokenFromCode(redirectUri, code) {
          ...
          var path2 = (0, _utils.OAuth2TokenUrl)(this.domain, this.domainDelimiter);
          path2 += "?grant_type=authorization_code";
          path2 += "&code=".concat(code);
          path2 += "&client_id=".concat(clientId);
          if (clientSecret) {
            path2 += "&client_secret=".concat(clientSecret);
          } else {
            if (!this.codeVerifier) {
              throw new Error("You must use PKCE when generating the authorization URL to not include a client secret");
            }
            path2 += "&code_verifier=".concat(this.codeVerifier);
          }
          if (redirectUri) {
            path2 += "&redirect_uri=".concat(redirectUri);
          }
          var fetchOptions = {
            method: "POST",
            headers: {
          ...
          return this.fetch(path2, fetchOptions).then(function(res) {
    ...
    exports2["default"] = DropboxAuth;
  }
});

// node_modules/dropbox/cjs/src/dropbox.js
var require_dropbox = __commonJS({
  "node_modules/dropbox/cjs/src/dropbox.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    ...
    var Dropbox2 = /* @__PURE__ */ (function() {
      function Dropbox3(options) {
        _classCallCheck(this, Dropbox3);
        options = options || {};
        if (options.auth) {
      ...
      _createClass(Dropbox3, [{
        key: "request",
        value: function request(path2, args, auth, host, style) {
          switch (style) {
            case _constants.RPC:
              return this.rpcRequest(path2, args, auth, host);
            case _constants.DOWNLOAD:
              return this.downloadRequest(path2, args, auth, host);
            case _constants.UPLOAD:
              return this.uploadRequest(path2, args, auth, host);
            default:
        ...
        key: "rpcRequest",
        value: function rpcRequest(path2, body, auth, host) {
          var _this = this;
          return this.auth.checkAndRefreshAccessToken().then(function() {
            ...
            return _this.fetch((0, _utils.baseApiUrl)(host, _this.domain, _this.domainDelimiter) + path2, fetchOptions);
          }).then(function(res) {
            return (0, _response.parseResponse)(res);
          });
        }
        ...
        key: "downloadRequest",
        value: function downloadRequest(path2, args, auth, host) {
          var _this2 = this;
          return this.auth.checkAndRefreshAccessToken().then(function() {
            var fetchOptions = {
              method: "POST",
            ...
            return _this2.fetch((0, _utils.baseApiUrl)(host, _this2.domain, _this2.domainDelimiter) + path2, fetchOptions);
          }).then(function(res) {
        ...
        key: "uploadRequest",
        value: function uploadRequest(path2, args, auth, host) {
          var _this3 = this;
          return this.auth.checkAndRefreshAccessToken().then(function() {
            ...
            return _this3.fetch((0, _utils.baseApiUrl)(host, _this3.domain, _this3.domainDelimiter) + path2, fetchOptions);
          }).then(function(res) {
            return (0, _response.parseResponse)(res);
          });
        }
    ...
    exports2["default"] = Dropbox2;
  }
});

// node_modules/dropbox/cjs/index.js
var require_cjs = __commonJS({
  "node_modules/dropbox/cjs/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    var _dropbox = require_dropbox();
    Object.defineProperty(exports2, "Dropbox", {
      enumerable: true,
      get: function get() {
    ...
    var _auth = require_auth();
    Object.defineProperty(exports2, "DropboxAuth", {
      enumerable: true,
      get: function get() {
    ...
    var _response = require_response();
    Object.defineProperty(exports2, "DropboxResponse", {
      enumerable: true,
      get: function get() {
    ...
    var _error = require_error();
    Object.defineProperty(exports2, "DropboxResponseError", {
      enumerable: true,
      get: function get() {
...
async function getDownloadedFileAsText(result) {
...
var handler = async (event) => {
  ...
  console.log("env path:", import_node_path.default.resolve(process.cwd(), ".env"));
  ...
  const dbx = new import_dropbox.Dropbox({ accessToken: token });
